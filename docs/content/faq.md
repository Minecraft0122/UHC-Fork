...
[configs]: https://gitlab.com/uhccore/uhccore/-/tree/1.20.13/src/main/resources
...
!!! example "Snippet: UhcCore plugin JAR dependency"
    ...
    === "Gradle (Groovy DSL)"
        ...
        ```groovy
        compileOnly "net.zerodind:uhccore:1.20.13"
        ```
...
[compare]: https://gitlab.com/uhccore/uhccore/-/compare?from=1.20.13&to=main
