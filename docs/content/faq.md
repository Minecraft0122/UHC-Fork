...
[configs]: https://gitlab.com/uhccore/uhccore/-/tree/1.20.8/src/main/resources
...
!!! example "Snippet: UhcCore plugin JAR dependency"
    ...
    === "Gradle (Groovy DSL)"
        ...
        ```groovy
        compileOnly "net.zerodind:uhccore:1.20.8"
        ```
...
[compare]: https://gitlab.com/uhccore/uhccore/-/compare?from=1.20.8&to=main
